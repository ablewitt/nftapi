...
public class NftBuilder {
  ...
  public NftBuilder setTTL(long ttl) throws ApiException {
    ...
    this.detailsParams = TransactionDetailsParams.builder().ttl(ttl).build();
    return this;
  }
  ...
  private void generateCBORBytes()
      throws AddressExcepion, CborSerializationException, ApiException {
    this.transactionCBORBytes =
        blockFrostHelper
            .getTxnHelperService()
  ...
  public BigInteger calculateFee()
      throws AddressExcepion, CborSerializationException, ApiException {
    BigInteger fee =
        blockFrostHelper.getFeeCalcService().calculateFee(mintTransaction, detailsParams, metaData);
