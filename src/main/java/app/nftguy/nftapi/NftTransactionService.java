...
public class NftTransactionService {
    ...
    private String submit() {
        InlineResponse2025 result = cardanoWalletHelper.SubmitTransaction(nftTransaction.getTransactionCBORBytes());
        if (result.getId().length() > 1) {
            ...
            logger.warn(String.format("Failed processing transaction %s",
